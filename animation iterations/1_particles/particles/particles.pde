...
String allwords ="My mother is French fries and is a testament to my confused life./My mother is a French plant and is a covenant to my life.";
PVector start  =new PVector(10, 60);
int tSize =35; //Textsize
