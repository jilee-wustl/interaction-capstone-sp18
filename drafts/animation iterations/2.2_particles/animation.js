(function(){
    ...
    var colors = ['#CE96A7', '#F7E860', '#F25C86', '#78BED3', '#268AA8'];
    ...
    function initText() {
        text = new createjs.Text("t", "30px 'Source Sans Pro'", "#020202");
    ...
    function formText() {
        ...
        if(textPixels.length < circles.length) {
            for(var j = textPixels.length; j<circles.length; j++) {
                circles[j].tween = TweenLite.to(circles[j], 0.9, {alpha: 0.1});
            }
        }
    }
    ...
    function explode() {
     ...
     var lettersArray = ["One", "Two", "Three", "Four"];
    ...
    function addListeners() {
        ...
        document.body.addEventListener('click', function(e) {
            e.preventDefault();
        $('#inputText').attr('value', lettersArray[i]);
