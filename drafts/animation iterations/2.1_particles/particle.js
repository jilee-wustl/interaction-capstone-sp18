var particleAlphabet = {
	...
	changeLetter: function() {
		var letters = "Comic Sans walks into a bar, and the bartender says, We don't serve your type./Comic Sans entra a un bar y el cantinero dice: No servimos a tu tipo./كوميك سانس يدخل بار ويقول النادل: نحن لا تخدم نوع الخاص بك./漫画のサンはバーに入って、ウェイターに言う：「私たちはあなたのタイプに奉仕しません」/Το Cartoon Sun εισέρχεται στο μπαρ και λέει στον σερβιτόρο: Δεν θα εξυπηρετήσουμε τον τύπο σας./Cartoon Sun går inn i baren og forteller servitøren: Vi vil ikke tjene din fyr./Мультяшное солнце входит в бар и говорит официанту: «Мы не будем служить вашему парню»./การ์ตูนดวงอาทิตย์เข้าบาร์และบอกพนักงานเสิร์ฟ: เราจะไม่ให้บริการแฟนของคุณ./Hoʻokomo ka lā i ka pā a haʻi i ke kahu: ʻAʻole mākou e lawelawe i kāu kāne./The sun went on the fence and told the nurse: We do not have to work for your husband.",
	...
	animate: function() {
		...
		particleAlphabet.ctx.fillStyle = 'rgba(0,0,0,0.05)';
