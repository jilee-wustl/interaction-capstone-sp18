...
String word = "O";
String allwords = "I wish my dog understood that it's not appropriate to harass the UPS people/Θα ήθελα το σκυλί μου να καταλάβει ότι δεν είναι σωστό να παρενοχλούν οι άνθρωποι από την UPS./私は犬がUPSから人々を邪魔するのは大丈夫だと理解するようにしたい。";
